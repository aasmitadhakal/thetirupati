    ...
    public function run(): void
    {
        $branches = [
            ...
            [
                'order' => 1,
                'status' => 1,
                'title' => 'The Tirupati Lagankhel',
                'short_description' => 'The Tirupati branch in Lagankhel, near Mangal Bazaar.',
                ...
                'email' => 'Ideal Educationeducare@gmail.com',
            ...
            [
                'order' => 2,
                'status' => 1,
                'title' => 'The Tirupati Itahari',
                'short_description' => 'The Tirupati branch in Itahari, offering educational services.',
                ...
                'email' => 'Ideal Educationdocuments@gmail.com',
            ...
            [
                'order' => 3,
                'status' => 1,
                'title' => 'The Tirupati Damak',
                'short_description' => 'The Tirupati branch in Damak, opposite Global IME Bank.',
                ...
                'email' => 'Ideal Educationdamak@gmail.com',
            ...
            [
                'order' => 4,
                'status' => 1,
                'title' => 'The Tirupati Biratnagar',
                'short_description' => 'The Tirupati branch in Biratnagar at Mahendra Chowk.',
                ...
                'email' => 'Ideal Educationbiratnagar@gmail.com',
            ...
            [
                'order' => 5,
                'status' => 1,
                'title' => 'The Tirupati Kathmandu',
                'short_description' => 'The Tirupati branch in Kathmandu near Chabahil Stupa.',
                'description' => 'Situated at Chabahil Stupa, Kathmandu, Nepal, offering a range of educational services and consultancy.',
                'email' => 'Ideal Educationeducarechabahil@gmail.com',
